...
const CreateBlog = () => {
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto overflow-y-auto mb-20 font-poppins">
      ...
      <form className="dark:border-none border shadow dark:shadow-slate-600 shadow-slate-400 p-4 rounded-md mb-4">
      ...
      <button
            ...
            className=" px-4 py-2  bg-crimson hover:bg-crimson/80 dark:bg-green hover:opacity-80 text-white rounded-lg hover:bg-green-600 transition-all"
          >
            Save Blog
          </button>
      </div>
