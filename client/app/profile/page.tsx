...
export default function Profile() {
  ...
  return (
    <section className="w-full max-h-screen flex items-center justify-center -z-10">
      <div className="bg-gray-800 text-white dark:text-gray-900 dark:bg-white h-1/2 w-[600px] max-w-[90%] flex flex-col items-center justify-center p-3 mt-4 rounded-md shadow">
        ...
        {/* name and email */}
        <section className="mt-8 flex flex-col gap-2 dark:shadow border border-slate-500 dark:border-slate-300 rounded-md p-2 py-4 w-[90%] max-500:w-full items-center relative mb-4 bg-transparent">
