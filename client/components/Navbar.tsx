  ...
  return (
    ...
    >
      <section className="flex justify-between items-center h-full w-[95%] mx-auto">
        <Link href={"/"} className={`${(pathname === '/admin' && userInfo?.role === 'admin') && 'flex items-center justify-center gap-2'}`}>
          <Image
            src={"/favicon.svg"}
            width={100}
            height={100}
        ...
        <div className="flex justify-between gap-[50px] max-800:gap-[30px] max-700:gap-[25px] ">
          <OutsideClickHandler onOutsideClick={() => setBar(false)}>
            ...
            >
              ...
              <li
                className={`relative ${pathname === "/admin" && "hidden"}`}
              >
                <div
              ...
              {userInfo?.role === "admin" && (
                <li className="max-700:mb-5">
                  <Link
                    href={"/admin"}
                    className={`hover:text-crimson dark:hover:text-green transition`} onClick={() => setBar(false)}
                  >
                    MyAdmin
                  </Link>
                </li>
          ...
          <div className={`flex gap-4 items-center ${pathname === '/admin' && 'hidden'}`}>
            {/* switch modes */}
            {theme === "light" ? (
              <Moon
